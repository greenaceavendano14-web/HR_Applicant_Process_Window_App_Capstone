namespace HRApplicantSystem
{
    partial class HiringDecisionForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnViewDecision = new Button();
            btnPrintDecision = new Button();
            btnApproveHiring = new Button();
            dgvHiringDecision = new DataGridView();
            colDecisionId = new DataGridViewTextBoxColumn();
            colApplicantName = new DataGridViewTextBoxColumn();
            colPosition = new DataGridViewTextBoxColumn();
            colInterviewResults = new DataGridViewTextBoxColumn();
            colHRRecommendation = new DataGridViewTextBoxColumn();
            colFinalDecision = new DataGridViewTextBoxColumn();
            ...
            panelMain.Controls.Add(btnViewDecision);
            panelMain.Controls.Add(btnPrintDecision);
            ...
            // btnViewDecision
            // 
            btnViewDecision.BackColor = Color.Thistle;
            btnViewDecision.FlatStyle = FlatStyle.Flat;
            btnViewDecision.Font = new Font("Segoe UI", 12F, FontStyle.Bold);
            btnViewDecision.Location = new Point(380, 550);
            btnViewDecision.Name = "btnViewDecision";
            btnViewDecision.Size = new Size(130, 55);
            btnViewDecision.TabIndex = 6;
            btnViewDecision.Text = "View Details";
            btnViewDecision.UseVisualStyleBackColor = false;
            // 
            // btnPrintDecision
            // 
            btnPrintDecision.BackColor = Color.Thistle;
            btnPrintDecision.FlatStyle = FlatStyle.Flat;
            btnPrintDecision.Font = new Font("Segoe UI", 12F, FontStyle.Bold);
            btnPrintDecision.Location = new Point(560, 550);
            btnPrintDecision.Name = "btnPrintDecision";
            btnPrintDecision.Size = new Size(130, 55);
            btnPrintDecision.TabIndex = 5;
            btnPrintDecision.Text = "Print Decision";
            btnPrintDecision.UseVisualStyleBackColor = false;
            // 
            // btnApproveHiring
            // 
            ...
            dgvHiringDecision.Columns.AddRange(new DataGridViewColumn[] { colDecisionId, colApplicantName, colPosition, colInterviewResults, colHRRecommendation, colFinalDecision });
            ...
            // colDecisionId
            // 
            colDecisionId.HeaderText = "Decision ID";
            colDecisionId.Name = "colDecisionId";
            colDecisionId.ReadOnly = true;
            // 
            // colApplicantName
            // 
            ...
            // colInterviewResults
            // 
            colInterviewResults.HeaderText = "Interview Results";
            colInterviewResults.Name = "colInterviewResults";
            colInterviewResults.ReadOnly = true;
            // 
            // colHRRecommendation
            // 
            colHRRecommendation.HeaderText = "HR Recommendation";
            colHRRecommendation.Name = "colHRRecommendation";
            colHRRecommendation.ReadOnly = true;
            // 
            // colFinalDecision
            // 
            colFinalDecision.HeaderText = "Final Decision";
            colFinalDecision.Name = "colFinalDecision";
            colFinalDecision.ReadOnly = true;
            // 
            // btnSearch
            // 
        ...
        private Button btnViewDecision;
        private Button btnPrintDecision;
