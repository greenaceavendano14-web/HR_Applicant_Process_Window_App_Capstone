...
DROP PROCEDURE IF EXISTS sp_RecordHiringDecision;
...
BEGIN
    ...
    DECLARE v_VacancyID INT;
    DECLARE v_SlotsAvailable INT;
    ...
    IF v_RoleName NOT IN ('HR Manager','Admin') THEN
        ...
        SET MESSAGE_TEXT =
        'Only HR Manager or Admin can make the final hiring decision.';
    ...
    ELSE
        ...
        IF p_Decision = 'Accepted' THEN
            ...
            UPDATE JobVacancies
            SET SlotsAvailable = SlotsAvailable - 1
            WHERE VacancyID = v_VacancyID
            AND SlotsAvailable > 0;

            SELECT SlotsAvailable
            INTO v_SlotsAvailable
            FROM JobVacancies
            WHERE VacancyID = v_VacancyID;

            IF v_SlotsAvailable <= 0 THEN
